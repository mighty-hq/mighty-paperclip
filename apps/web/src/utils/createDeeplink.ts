import { environment, LaunchProps, LaunchType } from '@mighty/api';
...
export type CreateExtensionDeeplinkBaseOptions = {
  ...
  command: string;
  /**
   * Either "userInitiated", which runs the command in the foreground, or "background", which skips bringing Mighty to the front.
   */
...
function getProtocol() {
  return environment.mightyVersion.includes('alpha') ? 'mightyinternal://' : 'mighty://';
}
