...
export const PromptInputSelectItem = ({ className, ...props }) => <SelectItem className={cn(className)} {...props} />;

export const PromptInputSelectValue = ({ className, ...props }) => <SelectValue className={cn(className)} {...props} />;
...
export const PromptInputCommand = ({ className, ...props }) => <Command className={cn(className)} {...props} />;

export const PromptInputCommandInput = ({ className, ...props }) => (
  <CommandInput className={cn(className)} {...props} />
);

export const PromptInputCommandList = ({ className, ...props }) => <CommandList className={cn(className)} {...props} />;
...
export const PromptInputCommandItem = ({ className, ...props }) => <CommandItem className={cn(className)} {...props} />;
