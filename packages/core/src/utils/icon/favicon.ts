import { Icon, Image } from '@mighty/api';
 ...
 *
 * @returns an Image that can be used where Mighty expects them.
 *
 * @example
 * ```
 * <List.Item icon={getFavicon("https://mightyshortcut.com")} title="Mighty Website" />
 * ```
 */
export function getFavicon(
  ...
  try {
    ...
    const faviconProvider: 'none' | 'https://github.com' | 'apple' | 'google' | 'duckDuckGo' | 'duckduckgo' | 'legacy' =
      (process.env.FAVICON_PROVIDER as any) ?? 'https://github.com';
