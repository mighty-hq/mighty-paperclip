import { Color, OAuth } from '@mighty/api';
...
export class OAuthService implements OAuthServiceOptions {
  ...
  public static asana(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      ...
      authorizeUrl: options.authorizeUrl ?? 'https://asana.oauth.mightyshortcut.com/authorize',
      tokenUrl: options.tokenUrl ?? 'https://asana.oauth.mightyshortcut.com/token',
      refreshTokenUrl: options.refreshTokenUrl ?? 'https://asana.oauth.mightyshortcut.com/refresh-token',
      scope: options.scope,
  ...
  public static github(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      ...
      authorizeUrl: options.authorizeUrl ?? 'https://github.oauth.mightyshortcut.com/authorize',
      tokenUrl: options.tokenUrl ?? 'https://github.oauth.mightyshortcut.com/token',
      refreshTokenUrl: options.refreshTokenUrl ?? 'https://github.oauth.mightyshortcut.com/refresh-token',
      scope: options.scope,
      personalAccessToken: options.personalAccessToken,
      onAuthorize: options.onAuthorize,
      bodyEncoding: options.bodyEncoding,
  ...
  public static linear(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      ...
      authorizeUrl: options.authorizeUrl ?? 'https://linear.oauth.mightyshortcut.com/authorize',
      tokenUrl: options.tokenUrl ?? 'https://linear.oauth.mightyshortcut.com/token',
      refreshTokenUrl: options.refreshTokenUrl ?? 'https://linear.oauth.mightyshortcut.com/refresh-token',
      scope: options.scope,
      extraParameters: {
        actor: 'user',
      },
  ...
  public static slack(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      ...
      authorizeUrl: options.authorizeUrl ?? 'https://slack.oauth.mightyshortcut.com/authorize',
      tokenUrl: options.tokenUrl ?? 'https://slack.oauth.mightyshortcut.com/token',
      refreshTokenUrl: options.tokenUrl ?? 'https://slack.oauth.mightyshortcut.com/refresh-token',
      scope: '',
      extraParameters: {
