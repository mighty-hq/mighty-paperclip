  ...
  return (
    <div className="flex h-full flex-col" data-testid="agents-page">
      <div className="px-8 pt-8 pb-4">
        <h1 className="mb-1 font-bold text-3xl text-[var(--text-primary)]">Agents</h1>
        <p className="text-[var(--text-secondary)] text-sm">
          Recipe-style team agent bundles with tree sections and markdown data
        </p>
      </div>
      ...
      <div className="mx-8 mb-8 flex-1 overflow-hidden rounded-xl border border-[var(--border)] bg-white/[0.03]">
        <AgentsBrowser searchQuery={searchQuery} />
      </div>
    </div>
  );
};
