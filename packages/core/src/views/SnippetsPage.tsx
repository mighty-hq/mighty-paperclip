...
const SnippetsPage: React.FC = () => {
  ...
  return (
    <div className="flex h-full flex-col" data-testid="snippets-page">
      <div className="flex items-center justify-between px-8 pt-8 pb-4">
        <div>
          <h1 className="mb-1 font-bold text-3xl text-[var(--text-primary)]">My Snippets</h1>
          <p className="text-[var(--text-secondary)] text-sm">Browse and manage your saved snippets</p>
        </div>
        <button
          onClick={() => navigate('/dashboard/snippets/new')}
