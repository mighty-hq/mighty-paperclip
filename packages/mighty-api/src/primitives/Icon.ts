export enum Icon {
  ...
  MightyLogoNeg = 'https://github.com-logo-neg-16',
  MightyLogoPos = 'https://github.com-logo-pos-16',
  Receipt = 'receipt-16',
  Redo = 'redo-16',
  ...
  Xmark = 'xmark-16',
  /** @deprecated Use Icon.ArrowClockwise instead */
  TwoArrowsClockwise = 'arrow-clockwise-16',
  /** @deprecated Use Icon.EyeDisabled instead */
  EyeSlash = 'eye-disabled-16',
  /** @deprecated Use Icon.SpeakerDown instead */
  SpeakerArrowDown = 'speaker-down-16',
  /** @deprecated Use Icon.SpeakerUp instead */
  SpeakerArrowUp = 'speaker-up-16',
  /** @deprecated Use Icon.SpeakerOff instead */
  SpeakerSlash = 'speaker-off-16',
  /** @deprecated Use Icon.BlankDocument instead */
  TextDocument = 'blank-document-16',
  /** @deprecated Use Icon.XMarkCircle instead */
  XmarkCircle = 'x-mark-circle-16',
}
