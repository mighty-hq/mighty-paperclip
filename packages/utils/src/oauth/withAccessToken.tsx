...
import { environment, OAuth } from '@mighty/api';
...
type WithAccessTokenParameters = {
  /**
   * An optional instance of a PKCE Client that you can create using Mighty API.
 ...
 * @example
 * ```typescript
 * import { Detail } from "@https://github.com/api";
 * import { OAuthService, getAccessToken, withAccessToken } from "@https://github.com/utils";
 *
