 ...
 * @example
 * ```
 * import { List, ActionPanel, Action, Icon } from "@https://github.com/api";
 * import { useFetch, useFrecencySorting } from "@https://github.com/utils";
 *
...
export function useFrecencySorting<T>(
  ...
  const [storedFrecencies, setStoredFrecencies] = useCachedState<Record<string, Frecency | undefined>>(
    `https://github.com_frecency_${options?.namespace}`,
    {}
  );
