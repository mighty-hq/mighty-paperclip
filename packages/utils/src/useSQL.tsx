import { List, MenuBarExtra, Icon, open, LaunchType, environment, ActionPanel, Action } from '@mighty/api';
 ...
 * @example
 * ```
 * import { useSQL } from "@https://github.com/utils";
  ...
  if (environment.commandMode === 'menu-bar') {
    return (
      <MenuBarExtra icon={Icon.Warning} title={environment.commandName}>
        <MenuBarExtra.Item
          title="Mighty needs full disk access"
  ...
  return (
    <List>
      <List.EmptyView
        icon={{
          source: {
            light: 'https://mightyshortcut.com/uploads/extensions-utils-security-permissions-light.png',
            dark: 'https://mightyshortcut.com/uploads/extensions-utils-security-permissions-dark.png',
          },
        }}
        title="Mighty needs full disk access."
        description={`${
